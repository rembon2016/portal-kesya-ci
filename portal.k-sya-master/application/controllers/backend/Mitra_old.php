...
class Mitra extends CI_Controller{
	...
	function index(){
		$x['data'] = $this->mitra_model->get_all_post()->result();
	...
	function add_new(){
		...
		$this->load->view('backend/v_add_mitra',$x);
	}
	...
	function get_edit(){
		...
		$x['tag']	   = $this->tag_model->get_all_tag();
		$x['category'] = $this->category_model->get_all_category();
		$x['data'] = $this->mitra_model->get_post_by_id($post_id);
	    ...
	    if(!empty($_FILES['filefoto']['name'])){
	        if ($this->upload->do_upload('filefoto')){
	           ...
	           // $this->_create_thumbs($img['file_name']);
				...
				$this->mitra_model->save_post($title,$link,$image,$description);
	...
	function delete(){
		...
		$this->mitra_model->delete_post($post_id);
