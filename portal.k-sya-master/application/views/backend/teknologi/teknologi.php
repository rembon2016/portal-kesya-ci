                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <a href="<?php echo site_url('backend/teknologi/add_new');?>" class="btn btn-success m-b-sm">Tambah Data Baru</a>
                                    ...
                                    <div class="table-responsive">
                                        <table id="data-table" class="display table" style="width: 100%; cellspacing: 0;">
                                            ...
                                            ?> 
                                                <tr>
                                                    <td><?php echo $no;?></td>
                                                    <td> <img class="img-circle avatar" src="<?php echo base_url().'assets/teknologi/'.$row->foto;?>" width="40" height="40" alt=""></td>
                                                    <td><?php echo $row->judul;?></td>
                                                    <td><?php echo $row->create_date;?></td>
                                                    <td style="text-align: center;">
                                                        <a href="<?php echo site_url('backend/teknologi/edit/'.$row->id);?>" class="btn btn-xs"><span class="fa fa-pencil"></span></a>
