    ...
    <body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
        ...
        <main class="page-content content-wrap">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open" ><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Produk Hukum</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="<?php echo site_url('backend/produkhukum');?>">Produk Hukum</a></li>
            ...
            <div class="page-inner">
                ...
                <div id="main-wrapper">
                    <div class="row">
                        <form action="<?php echo base_url().'backend/Produkhukum/publish'?>" method="post" enctype="multipart/form-data">
                        <div class="col-md-8">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                        ...
                                        <!-- <div class="form-group">
                                            <input type="text" name="slug" class="form-control" placeholder="Permalink" style="background-color: #F8F8F8;outline-color: none;border:0;color:blue;">
                                        </div> -->
                                        <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label>Atau Dari Link</label>
                                            <input type="text" name="link" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Kategori Produk Hukum</label>
            ...
            $(document).ready(function(){
                ...
                function sendFile(file, editor, welEditable) {
                    ...
                    $.ajax({
                        data: data,
                        type: "POST",
                        url: "<?php echo site_url()?>backend/Produkhukum/upload_image",
                        cache: false,
                        contentType: false,
                        processData: false,
