                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-3 center">
                            <div class="login-box">
                                <a href="#" class="logo-name text-lg text-center">K-SYA</a>
                                <p class="text-center m-t-md">Silahkan Login</p>
                                ...
                                <p class="text-center m-t-xs text-sm"><?php echo date('Y');?> &copy; k-sya</p>
                            </div>
                        </div>
                    </div><!-- Row -->
                </div><!-- Main Wrapper -->
