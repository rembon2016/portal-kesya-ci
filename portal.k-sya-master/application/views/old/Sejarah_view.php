				...
				<div class="row">
                    <div class="col-lg-7 col-sm-10">
                        <div class="hero-area-content ptb-80">
                            <h1>Sejarah KKT-PTI</h1>
                            <p>KKT-PTI dirancang memberikan program berdampak tinggi untuk outputyang Luar Biasa dan Realistis. yang mendukung mereka untuk menciptakanPemimpin-Pemimpin muda yang Milenial hingga 2,5 juta orang dalam komunitasyang bertujuan memberikan Motivasi, Edukasi dan Terapan bagi masyarakatterkhusus petani kecil yang ada disekitar untuk tujuan membangun kembalikehidupan mereka</p>
				...
				<div class="row">
					<div class="col-lg-6">
                        <div class="about-area-content">
                            <img src="https://i.ibb.co/71yFSh3/DSC-2286.jpg" alt="about">
                        </div>
					</div>
					<div class="col-lg-6">
                        <div class="about-area-content">
                            <h2>Tentang Kami</h2>
                            <p>Komando Kawasan Terpaut Pemuda Tani Indonesia atau disingkat
                            KKT-PTI
                            merupakan Pondasi utama bagi Pemerintah menjadi Akselarasi Peran dan PerananPemuda Tani diharapkan dapat tumbuh sebagai Pilar penting Pertumbuhan ekonomiNasional. Manajemen Pengelolaan Tekhnologi Komoditas dan Varietas yang tepatakan mendorong kalangan muda Indonesia harus kembali menekuni dunia pertaniansehingga Sektor Pertanian dapat Menjadi Jiwa dan Panggilan semur hidup bagiKaum Muda yang ada diseluruh Indonesia</p>
                            <p></p>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6">
                        <div class="about-area-content">
                            <h2>Tujuan Kami</h2>
                            <p>Menjadi Lantera dan Pilar bagi setiap Petani dan kelompok tani adalah dasarUtama bagi KKT-PTI dalam peningkatan Motivasi, dan Adopsi Terhadap integrasiantar Intensifikasia Tekhnologi Budidaya Komoditas orientasi manajemen Hulu keHilir untuk Pertanian Maju, Milenial dan Moder</p>
					...
					<div class="col-lg-6">
                        <div class="about-area-content">
                                <iframe 
                                         src="https://www.youtube.com/watch?v=fKnclY_i2IE" allowfullscreen>
                                </iframe>
