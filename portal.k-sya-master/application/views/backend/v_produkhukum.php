...
<html>
    ...
    <body class="page-header-fixed compact-menu pace-done page-sidebar-fixed">
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="<?php echo site_url('backend/komisioner');?>" class="waves-effect waves-button"><span class="menu-icon icon-users"></span><p>Komisioner</p></a></li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <a href="<?php echo site_url('backend/Produkhukum/add_new');?>" class="btn btn-success m-b-sm">Tambah Data baru</a>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <a href="<?php echo site_url('backend/Produkhukum/get_edit/'.$row->id);?>" class="btn btn-xs"><span class="fa fa-pencil"></span></a>
        ...
        <!--DELETE RECORD MODAL-->
        <form action="<?php echo site_url('backend/Produkhukum/delete');?>" method="post">
