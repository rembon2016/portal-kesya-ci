...
<html>
    ...
    <body class="page-header-fixed compact-menu pace-done page-sidebar-fixed">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Mitra</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="<?php echo site_url('backend/mitra');?>">Mitra List</a></li>
                                    ...
                                    <div class="table-responsive">
                                        <table id="data-table" class="display table" style="width: 100%; cellspacing: 0;">
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?php echo $no;?></td>
                                                    <td> <img class="img-circle avatar" src="<?php echo base_url().'assets/mitra/'.$row->post_image;?>" width="40" height="40" alt=""></td>
                                                    <td><?php echo $row->post_title;?></td>
                                                    <td><?php echo $row->post_date;?></td>
                                                    <!-- <td><?php // echo $row->category_name;?></td>
                                                    <td><?php // echo $row->post_views;?></td> -->
                                                    <td style="text-align: center;">
                                                        <a href="<?php echo site_url('backend/mitra/get_edit/'.$row->post_id);?>" class="btn btn-xs"><span class="fa fa-pencil"></span></a>
        ...
        <!--DELETE RECORD MODAL-->
        <form action="<?php echo site_url('backend/mitra/delete');?>" method="post">
