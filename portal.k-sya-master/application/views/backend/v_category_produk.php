...
<html>
    <head>
        <!-- Title -->
        <title>Kategori Produk Hukum</title>
    ...
    <body class="page-header-fixed compact-menu pace-done page-sidebar-fixed">
        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                          <a href="<?php echo site_url('backend/dashboard');?>" class="logo-text"><span>KKT-PTI</span></a>
                    </div><!-- Logo Box -->
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Post</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                        ...
                        <li ><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Mitra</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                        ...
                        <li class="droplink active open" ><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Produk Hukum</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li  class="active" ><a href="<?php echo site_url('backend/Category_produkhukum');?>">Kategori</a></li>
                                <li><a href="<?php echo site_url('backend/mitra');?>">Produk Hukum</a></li>
                              
                            </ul>
                        </li>
                        <li ><a href="<?php echo site_url('backend/komisioner');?>" class="waves-effect waves-button"><span class="menu-icon icon-users"></span><p>Komisioner</p></a></li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <button type="button" class="btn btn-success m-b-sm" data-toggle="modal" data-target="#myModal">Tambah Data baru</button>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-edit" data-id="<?php echo $row->id;?>" data-category="<?php echo $row->title;?>"><span class="fa fa-pencil"></span></a>
        ...
        <!--ADD RECORD MODAL-->
        <form action="<?php echo site_url('backend/Category_produkhukum/save');?>" method="post">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <input type="text" name="category" class="form-control" placeholder="Produk Hukum" required>
                            </div>
                        </div>
        ...
        <!--EDIT RECORD MODAL-->
        <form action="<?php echo site_url('backend/Category_produkhukum/edit');?>" method="post">
            <div class="modal fade" id="EditModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Edit Produk Hukum</h4>
                    </div>
                        <div class="modal-body">
                            <div class="form-group">
                                <input type="text" name="category2" class="form-control" placeholder="Produk Hukum" required>
                            </div>
                        </div>
                        <div class="modal-footer">
        ...
        <!--DELETE RECORD MODAL-->
        <form action="<?php echo site_url('backend/Category_produkhukum/delete');?>" method="post">
            <div class="modal fade" id="DeleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Delete Produk Hukum</h4>
                    </div>
                        <div class="modal-body">
