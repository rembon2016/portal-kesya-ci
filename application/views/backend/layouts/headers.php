            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-home"></span><p>Beranda</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="<?php echo site_url('backend/slider');?>">Slider</a></li>
                                <li><a href="<?php echo site_url('backend/beranda_page');?>">Page Beranda</a></li>
                            </ul>
                        </li>
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-home"></span><p>Tentang Kami</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="<?php echo site_url('backend/about');?>">Sejarah</a></li>
                                <li><a href="<?php echo site_url('backend/visi');?>">Visi</a></li>
                                <li><a href="<?php echo site_url('backend/misi');?>">Misi</a></li>
                                <li><a href="<?php echo site_url('backend/organisasi');?>">Struktur Organisasi</a></li>
                                <!-- <li><a href="<?php echo site_url('backend/teknologi');?>">Teknologi KKTPTI</a></li> -->
                            </ul>
                        </li>
                        ...
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Blog</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="<?php echo site_url('backend/post/add_new');?>">Add New</a></li>
                                <li><a href="<?php echo site_url('backend/post');?>">Blog List</a></li>
                        ...
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Gallery</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                ...
                                <li><a href="<?php echo site_url('backend/gallery');?>">Foto</a></li>
                                <li><a href="<?php echo site_url('backend/video');?>">Video</a></li>
                            </ul>
                        </li>
