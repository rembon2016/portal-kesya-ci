...
class Settings extends CI_Controller{
	...
	function update(){
	    ...
	    if(!empty($_FILES['logo_header']['name']) && !empty($_FILES['logo_footer']['name'])){
	        ...
	        $this->site_model->update_information($site_id,$site_name,$site_title,$site_description,$logo_header,$logo_footer,$facebook,$twitter,$linkedin,$instagram,$pinterest,$address,$phone,$maps);
	        ...
	        $this->site_model->update_information_header($site_id,$site_name,$site_title,$site_description,$logo_header,$facebook,$twitter,$linkedin,$instagram,$pinterest,$address,$phone,$maps);
	        $this->session->set_flashdata('msg','success');
	        redirect('backend/settings');
	        ...
	        $this->site_model->update_information_footer($site_id,$site_name,$site_title,$site_description,$logo_footer,$facebook,$twitter,$linkedin,$instagram,$pinterest,$address,$phone,$maps);
	        $this->session->set_flashdata('msg','success');
	        redirect('backend/settings');

	    }else{
	    	$this->site_model->update_information_nologo($site_id,$site_name,$site_title,$site_description,$facebook,$twitter,$linkedin,$instagram,$pinterest,$address,$phone,$maps);
	        $this->session->set_flashdata('msg','success');
	        redirect('backend/settings');
	    }
	}
