<?php $this->load->view('backend/layouts/headers');?>
            <div class="page-title">
                ...
                <div id="main-wrapper">
                    <div class="row"> 
                        <form action="<?php echo base_url().'backend/mitra/update'?>" method="post" enctype="multipart/form-data">
                        <div class="col-md-8">
                        ...
                        <div class="col-md-4">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="form-group"> 
                                            <label>Image</label>
                                            <input type="file" name="filefoto" class="dropify" data-height="190" data-default-file="<?php echo base_url().'assets/mitra/'.$data->foto;?>">
                                        </div>
