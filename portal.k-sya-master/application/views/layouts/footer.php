    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-low py-3 bg-light "
      ...
      <div class="container">
          <a class="text-700 text-dark-px=1" href="<?= site_url('tentang_kami') ?>">Contact Us</li>
          <a class="text-700 text-dark-px=1" href="<?= site_url('tentang_kami') ?>">Terms of use</li>
          <a class="text-700 text-dark-px=1" href="<?= site_url('tentang_kami') ?>">Privacy Policy</li>

          <a class="text-500 text-decoration-none" href="<?= site_url('tentang_kami') ?>">Copy @2010 Reallbyte Inc All right</a>
              </li>
