    ...
    <body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open" ><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Mitra</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li class="active"><a href="<?php echo site_url('backend/mitra/add_new');?>">Add New</a></li>
            ...
            <div class="page-inner">
                ...
                <div id="main-wrapper">
                    <div class="row">
                        <form action="<?php echo base_url().'backend/mitra/publish'?>" method="post" enctype="multipart/form-data">
                        <div class="col-md-8">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label>Link</label>
                                            <input type="text" name="slug" class="form-control" placeholder="Link Web Mitra"  required>
                                        </div>
                                        <div class="form-group">
