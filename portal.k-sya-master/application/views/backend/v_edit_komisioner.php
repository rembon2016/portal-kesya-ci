        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                        <a href="<?php echo site_url('backend/dashboard');?>" class="logo-text"><span>KOMPOLNAS</span></a>
                    </div><!-- Logo Box -->
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open" ><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Komisioner</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li ><a href="<?php echo site_url('backend/komisioner/add_new');?>">Add New</a></li>
                                <li class="active"><a href="<?php echo site_url('backend/komisioner');?>">Komisioner List</a></li>
                        ...
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Gallery</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="<?php echo site_url('backend/album');?>">Album</a></li>
                                <li ><a href="<?php echo site_url('backend/gallery');?>">Gallery Photo</a></li>
            ...
            <div class="page-inner">
                ...
                <div id="main-wrapper">
                    <div class="row">
                        <form action="<?php echo base_url().'backend/komisioner/edit'?>" method="post" enctype="multipart/form-data">
                        <div class="col-md-8">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label>Nama</label>
                                            <input type="text" name="title" value="<?php echo $b['post_title'];?>" class="form-control" placeholder="Nama Lengkap" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Jabatan</label>
                                            <input type="text" name="jabatan" value="<?php echo $b['post_jabatan'];?>" class="form-control" placeholder="Jabatan"  required>
                                        </div>
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="text" name="email"  value="<?php echo $b['post_email'];?>" class="form-control" placeholder="Email"  required>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Keterangan Tambahan/ Riwayat Singkat</label>
                                            <textarea name="contents" id="summernote"><?php echo $b['post_description'];?></textarea>
                                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                        <div class="form-group">
                                            <label>Image</label>
                                            <input type="file" name="filefoto" class="dropify" data-height="190" data-default-file="<?php echo base_url().'assets/komisioner/'.$b['post_image'];?>">
                                        </div>
                ...
                <p class="no-s"><?php echo date('Y');?> &copy; kompolnas.go.id</p>
                </div>
            </div><!-- Page Inner -->
        </main><!-- Page Content -->
