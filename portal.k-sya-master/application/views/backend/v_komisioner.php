...
<html>
    ...
    <body class="page-header-fixed compact-menu pace-done page-sidebar-fixed">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <a href="<?php echo site_url('backend/komisioner/add_new');?>" class="btn btn-success m-b-sm">Tambah Data Baru</a>
                                    ...
                                    <div class="table-responsive">
                                        <table id="data-table" class="display table" style="width: 100%; cellspacing: 0;">
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?php echo $no;?></td>
                                                    <td> <img class="img-circle avatar" src="<?php echo base_url().'assets/komisioner/'.$row->post_image;?>" width="40" height="40" alt=""></td>
                                                    <td><?php echo $row->post_title;?></td>
                                                    <td><?php echo $row->post_date;?></td>
                                                    <!-- <td><?php // echo $row->category_name;?></td>
                                                    <td><?php // echo $row->post_views;?></td> -->
                                                    <td style="text-align: center;">
                                                        <a href="<?php echo site_url('backend/komisioner/get_edit/'.$row->post_id);?>" class="btn btn-xs"><span class="fa fa-pencil"></span></a>
        ...
        <!--DELETE RECORD MODAL-->
        <form action="<?php echo site_url('backend/komisioner/delete');?>" method="post">
