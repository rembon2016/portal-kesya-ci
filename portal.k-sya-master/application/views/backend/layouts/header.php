        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                                <a href="<?php echo site_url('backend/dashboard');?>" class="logo-text"><span>K-SYA</span></a>
                    </div><!-- Logo Box -->
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu"> 
                        ...
                        <li><a href="<?php echo site_url('backend/slider');?>" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Slider</p></a></li>
                        <li><a href="<?php echo site_url('backend/about');?>" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Tentang Kami</p></a></li>
                        <li><a href="<?php echo site_url('backend/layanan');?>" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Layanan</p></a></li>
                        <li><a href="<?php echo site_url('backend/visi');?>" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Visi</p></a></li>
                        <li><a href="<?php echo site_url('backend/misi');?>" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Misi</p></a></li>
                        <li><a href="<?php echo site_url('backend/organisasi');?>" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Organisasi</p></a></li>
                        ...
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Mitra</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="<?php echo site_url('backend/mitra/add_new');?>">Add New</a></li>
                                <li><a href="<?php echo site_url('backend/mitra');?>">Mitra List</a></li>
                              
                            </ul>
                        </li>
                        <li class="droplink " ><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Komisioner</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li ><a href="<?php echo site_url('backend/komisioner/add_new');?>">Add New</a></li>
                                <li ><a href="<?php echo site_url('backend/komisioner');?>">Komisioner List</a></li>
                              
                            </ul>
                        </li>
                        <li class="droplink" ><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Produk Hukum</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="<?php echo site_url('backend/Category_produkhukum');?>">Kategori</a></li>
                                <li><a href="<?php echo site_url('backend/produkhukum');?>">Produk Hukum</a></li>
                              
                            </ul>
                        </li>
                        <li class="droplink" ><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Buku</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="<?php echo site_url('backend/Categorybuku');?>">Kategori Buku</a></li>
                                <li><a href="<?php echo site_url('backend/Buku');?>">Buku</a></li>
                              
                            </ul>
                        </li>
                        <li class="droplink active open"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Gallery</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="<?php echo site_url('backend/album');?>">Album</a></li>
                                <li class="active" ><a href="<?php echo site_url('backend/gallery');?>">Gallery Photo</a></li>
                              
                            </ul>
                        </li>
                        <li class="droplink" ><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span><p>Pengumuman</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li ><a href="<?php echo site_url('backend/pengumuman/add_new');?>">Add New</a></li>
                                <li><a href="<?php echo site_url('backend/pengumuman');?>">Pengumuman List</a></li>
