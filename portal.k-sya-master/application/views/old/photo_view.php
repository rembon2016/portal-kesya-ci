				...
				<div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <div class="hero-area-content">
                            <h1 class="text-uppercase">Photo Gallery</h1>
						...
						<div class="col-lg-3 col-sm-6 new other">
							<a class="example-image-link" href="<?php echo base_url();?>assets/gallery/<?php echo $row->post_image;?>" data-lightbox="example-set" data-title="<?php echo $row->post_title;?>">
								<div class="product-gallery-item max-width-360">
									<img class="product-gallery-item max-width-360" src="<?php echo base_url();?>assets/gallery/<?php echo $row->post_image;?>" alt="<?php echo $row->post_title;?>" />
									<div class="product-gallery-overlay">
									<!-- <img src="<?php echo base_url();?>assets/gallery/<?php echo $row->post_image;?>" alt="<?php echo $row->post_title;?>" /> -->
